...
{
  /// <summary>
  /// Illustrates how to delete an attributed relationship from an AttributedRelationshipClass's intermediate table.  In addition to 
  ...
  /// </para>
  /// </remarks> 
  public class AttributedRelationshipClassDeleteRelationship
  {
    /// <summary>
    /// In order to illustrate that Geodatabase calls have to be made on the MCT
    /// </summary>
    /// <returns></returns>
    public async Task AttributedRelationshipClassDeleteRelationshipAsync()
    {
